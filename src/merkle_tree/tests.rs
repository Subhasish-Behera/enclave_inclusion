...
mod test {
    ...
    fn test_merkle_tree() {
        ...
        println!("test");
        println!("sibling_leaf_node_hash_preimage: {:?}", proof.sibling_leaf_node_hash_preimage);
        println!("sibling_middle_node_hash_preimages: {:?}", proof.sibling_middle_node_hash_preimages);
        println!("path_indices: {:?}", proof.path_indices);
