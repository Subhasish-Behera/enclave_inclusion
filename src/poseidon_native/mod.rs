...
use crate::poseidon_native::hasher::{Hasher, RoundParams};
...
/// Constructs objects.
#[derive(Clone)]
pub struct PoseidonNative<const WIDTH: usize, P> where
	P: RoundParams<WIDTH>,
{
	inputs: [Fp; WIDTH],
	_params: PhantomData<P>,
}
impl<const WIDTH: usize, P> Hasher<WIDTH> for PoseidonNative<WIDTH, P>
where
	P: RoundParams<WIDTH>,
{
...
impl<const WIDTH: usize, P> PoseidonNative<WIDTH, P>
where
	P: RoundParams<WIDTH>,
{
	/// Create the objects.
	pub fn new(inputs: [Fp; WIDTH]) -> Self {
...
mod test {
	use super::*;
	use crate::poseidon_native::hasher::{hex_to_field, poseidon_bn254_5x5::Params};
	use halo2_proofs::halo2curves::bn256::Fr;

	type TestPoseidon = PoseidonNative<5, Params>;
